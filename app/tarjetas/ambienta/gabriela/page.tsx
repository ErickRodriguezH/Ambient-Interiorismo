    ...
    >
      ...
      >
        <style>{`
          ...
          .contact-item-g:hover { transform: translateX(4px); }
          .contact-item-g:hover .contact-icon-g {
            background: rgba(201,168,76,0.15) !important;
            border-color: #C9A84C !important;
          }
        `}</style>

        <div className="card-glow-g" style={{ position: 'relative' }}>
          <div
            style={{
              background: '#1c1b1b',
              borderRadius: 16,
          ...
          >
            ...
            <div style={{ background: '#2a2828', padding: '14px 36px', display: 'flex', gap: 6, flexWrap: 'wrap', borderBottom: '1px solid rgba(201,168,76,0.1)' }}>
              {['Persianas', 'Cortinas', 'Smart Film', 'Toldos', 'Pisos', 'Madera', 'Papel Tapiz', 'Pasto Sintético'].map((s) => (
                <span key={s} className="service-tag-g" style={{ fontSize: 7.5, fontWeight: 600, letterSpacing: 1.5, textTransform: 'uppercase', color: '#9a9080', padding: '4px 8px', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 3, transition: 'all 0.25s', cursor: 'default' }}>
                  {s}
                </span>
              ))}
            </div>
            ...
            <div style={{ padding: '24px 36px 30px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              {/* whatsapp */}
              <a className="contact-item-g" href="https://wa.me/5255858503850" target="_blank" rel="noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: 14, textDecoration: 'none', transition: 'transform 0.2s' }}>
                <div className="contact-icon-g" style={{ width: 38, height: 38, borderRadius: 8, background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, transition: 'all 0.25s' }}>
                ...
                <div>
                  ...
                  <span style={{ fontSize: 14, color: '#F2EDE4', display: 'block', marginTop: 2, fontFamily: 'var(--font-cormorant), serif', letterSpacing: 0.5 }}>55 8580 3850</span>
                </div>
              </a>

              {/* website */}
              <a className="contact-item-g" href="https://ambient-interiorismo.vercel.app" target="_blank" rel="noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: 14, textDecoration: 'none', transition: 'transform 0.2s' }}>
                <div className="contact-icon-g" style={{ width: 38, height: 38, borderRadius: 8, background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, transition: 'all 0.25s' }}>
                  <svg viewBox="0 0 24 24" width={18} height={18} fill="#C9A84C">
