        ...
        <div className="card-glow-fdav" style={{ position: 'relative' }}>
          ...
          >
            ...
            <div style={{ padding: '24px 36px 30px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <a
                className="contact-item-fdav"
                href="mailto:felipe_r@fdavtelecomunicaciones.com.mx"
              >
                <div
                  className="contact-icon-fdav"
                  style={{
                ...
                <div>
                  ...
                  <span style={{ fontSize: 11, color: '#F5F0F2', display: 'block', marginTop: 2, fontFamily: 'var(--font-cormorant), serif', letterSpacing: 0.3 }}>
                    felipe_r@fdavtelecomunicaciones.com.mx
                  </span>
                </div>
              </a>
