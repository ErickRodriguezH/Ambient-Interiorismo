...
export const metadata: Metadata = {
  title: 'Felipe Rodríguez Salazar — Ambienta Interiorismo',
      ...
      >
        ...
        <div className="card-glow" style={{ position: 'relative' }}>
          ...
          >
            ...
            >
              {['Persianas', 'Cortinas', 'Smart Film', 'Toldos', 'Pisos', 'Madera', 'Papel Tapiz', 'Pasto Sintético'].map(
                (s) => (
                  <span
                    key={s}
            ...
            <div style={{ padding: '24px 36px 30px', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              >
                ...
                <div>
                  <span style={{ fontSize: 8, fontWeight: 600, letterSpacing: 2, textTransform: 'uppercase', color: '#9a9080', display: 'block' }}>
                    Tel / WhatsApp
                  </span>
                  <span style={{ fontSize: 14, color: '#F2EDE4', display: 'block', marginTop: 2, fontFamily: 'var(--font-cormorant), serif', letterSpacing: 0.5 }}>
                    55 7394 4084
                  </span>
                </div>
              </a>
              ...
              <a
                className="contact-item"
                href="https://ambient-interiorismo.vercel.app"
                target="_blank"
                rel="noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: 14, textDecoration: 'none', transition: 'transform 0.2s' }}
              >
                ...
                <div>
                  ...
                  <span style={{ fontSize: 14, color: '#F2EDE4', display: 'block', marginTop: 2, fontFamily: 'var(--font-cormorant), serif', letterSpacing: 0.5 }}>
                    ambient-interiorismo.vercel.app
                  </span>
                </div>
              </a>
            </div>
